...
const store = new Vuex.Store({
  state: {
    ...
    defaultTag: [
      ...
      { name: '日用', iconName: 'daily', id: '10' },
      { name: '医疗', iconName: 'medical', id: '11' },
      { name: '零食', iconName: 'snacks', id: '12' },
      { name: '房贷', iconName: 'home', id: '13' },
      { name: '文教', iconName: 'education', id: '14' },
      { name: '医疗', iconName: 'medical', id: '15' },
      { name: '零食', iconName: 'snacks', id: '16' },
      { name: '房贷', iconName: 'home', id: '17' },
      { name: '文教', iconName: 'education', id: '18' },
      { name: '文教', iconName: 'education', id: '19' },
    ],
  } as RootState,
  mutations: {
